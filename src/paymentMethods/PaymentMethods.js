          ...
          <MDBCol md="8">
            <MDBCard className="mb-4">
              <MDBCardHeader className="py-3">
                <MDBTypography tag="h5" className="mb-0">Cart - 2 items</MDBTypography>
              </MDBCardHeader>
              <MDBCardBody>
                <MDBRow>
                  <MDBCol lg="3" md="12" className="mb-4 mb-lg-0">
                    <MDBRipple rippleTag='div' rippleColor="light" className='bg-image rounded hover-zoom hover-overlay'>
                      <img src='https://mdbcdn.b-cdn.net/img/Photos/Horizontal/E-commerce/Vertical/12a.webp' className='w-100' />
                      <a href="#!">
                  ...
                  <MDBCol lg="5" md="6" className=" mb-4 mb-lg-0">
                    ...
                    <MDBTooltip wrapperProps={{ size: "sm", color: "danger" }} wrapperClass="me-1 mb-2" title="Move to the wish list">
